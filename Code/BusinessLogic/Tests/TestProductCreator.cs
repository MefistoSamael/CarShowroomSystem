...
namespace BusinessLogic.Tests
{
    ...
    public class CreateCar
    {
        ...
        public void CreateCar_AddsCarToDatabase()
        {
            ...
            // Act
            var result = _carCreator.CreateCar(carModel, engineType, gearboxType, fuelTankCapacity, manufactureDate, carColor, wheelDriveType, power, fuelConsumption, name, price, manufacturer, inStock, photoPath);
    ...
    public void ChangeCarInfo_CarExists_ReturnsCar()
    {
        ...
        // Act
        var result = carManager.ChangeCarInfo(CarModel.Toyota_Corolla, EngineType.Electric_Motor, GearboxType.Automatic_Transmission, 60, new DateTime(2022, 1, 1), CarColor.Red, WheelDriveType.Rear_Wheel_Drive, 250, 12, car.Id, "Car2", 25000, "Manufacturer2", false, "/photos/car2.jpg");
    ...
    public void ChangeCarInfo_CarDoesNotExist_ReturnsNull()
    {
        ...
        // Act
        var result = carManager.ChangeCarInfo(CarModel.Toyota_Corolla, EngineType.Electric_Motor, GearboxType.Automatic_Transmission, 60, new DateTime(2022, 1, 1), CarColor.Red, WheelDriveType.Rear_Wheel_Drive, 250, 12, Guid.NewGuid(), "Car2", 25000, "Manufacturer2", false, "/photos/car2.jpg");
    ...
    public class EngineOilTests
    {
        ...
        public void CreateEngineOil_AddsToDatabase()
        {
            ...
            // Act
            var result = engineOilService.CreateEngineOil(composition, viscosity, engineType, name, price, manufacturer, inStock, photoPath);
...
public class TiresServiceTests
{
    ...
    public void CreateTires_WithValidData_ShouldReturnNewTires()
    {
        ...
        // Act
        var actualTires = tiresService.CreateTires(season, width, profileHeight, constructionType, rimDiameter, loadIndex, speedIndex, name, price, manufacturer, inStock, photoPath);
